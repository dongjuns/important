...
json_used = 'Golden'
datalumi =  35920#35.9fb-1
#datalumi =  5975 #35.9fb-1

#datalumi = 8360.481454 #35.9fb-1
version = os.environ['CMSSW_VERSION']

rootfileDir = "%s/src/nano/analysis/topMass/Results/Nano_C_Test/results_merged/ttbar_"% os.environ['CMSSW_BASE']
...
weight = 'genweight'
#plotvar = 'met'
plotvar = 'Nu_Jet'#'Nu_BJet'#'Dilep.M()'
binning = [10, 0, 10]#[6,0,6]#[60, 20, 320]#[150, 50, 200]#[150, 50, 200]
