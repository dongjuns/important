...
nanorootdir = "/cms/scratch/jdj0715/nanoAOD/src/nano/analysis/test/Results/Nano_NewCut/results_merged/ttbar_"
...
miniplotvar = 'dilep.M()'#"Dilep.M()"
nanoplotvar = 'Dilep.M()'#'Dilep.M()'#"Dilep.M()"
#nanoplotvar = "lep1.Pt()"
...
y_name = 'Events'
dolog = True
f_name = 'Compare_'#'SingleB3_Comp_step5'#'DY_before_trig'
