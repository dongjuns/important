...
rootfileDir = "/cms/scratch/jdj0715/nanoAOD/src/nano/analysis/test/topmass/Results/Nano_NewCut/results_merged/ttbar_"
...
x_name = 'dilep_mass'#'Invariant Mass'
y_name = 'Events'
dolog = True
f_name = 'Dilep_M_B'
#minp = 0.05
...
try:
    ...
    print 'Usage : ./draw_Top.py -c <cut> -w <weight> -b <binning> -p <plotvar> -x <x_name> -y <y_name> -f <f_name> -j <json_used> -d <dolog>'
    sys.exit(2)
for opt, arg in opts:
    if opt == '-h':
        print 'Usage : ./draw_Top.py -c <cut> -w <weight> -b <binning> -p <plotvar> -x <x_name> -y <y_name> -f <f_name> -j <json_used> -d <dolog>'
...
#        title = title+" #times 30"
    ...
    wentries = tfile.Get("genweight").Integral(0,1)
